...
# When build fails, copy all files in ./build/.libs to ./build
# Symlink /build/.libs to /build
define SDL2_PRE_BUILD_LIBFIX
#	mkdir $(@D)/build
#	ln -s $(@D)/build $(@D)/build/.libs
endef
...
# For Raspberry Pi (Version 1) ignore above configuration and use this one.
ifeq ($(BR2_PACKAGE_SDL2_RPI),y)
...
SDL2_CONF_OPTS += \
	...
	--disable-video-x11
SDL2_CONF_ENV += INCLUDES="-I$(STAGING_DIR)/usr/include \
	-I$(STAGING_DIR)/usr/include/interface/vcos/pthreads \
	-I$(STAGING_DIR)/usr/include/interface/vmcs_host/linux \
	-L$(@D)/build/.libs"
SDL2_PRE_BUILD_HOOKS += SDL2_PRE_BUILD_LIBFIX
else
