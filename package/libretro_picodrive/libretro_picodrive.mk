...
LIBRETRO_PICODRIVE_DEPENDENCIES = libpng sdl_dispmanx
...
define LIBRETRO_PICODRIVE_BUILD_CMDS
	...
	CXXFLAGS="$(TARGET_CXXFLAGS)" $(MAKE) \
	CC="$(TARGET_CC)" \
	CXX="$(TARGET_CXX)" -C  $(@D)/picodrive -f Makefile.libretro platform="$(LIBRETRO_PLATFORM) armasm"
endef
